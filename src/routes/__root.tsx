  ...
  head: () => ({
    meta: [
      ...
      { title: "BRICCA Foundation — Transforming Lives, Empowering Communities" },
      {
        name: "description",
        content:
          "BRICCA Foundation delivers education, livelihood, health and inclusion programmes for rural, tribal and coastal communities in Andhra Pradesh since 2019.",
      },
      { name: "author", content: "BRICCA Foundation" },
...
function MobileDonateBar() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 p-3 backdrop-blur-xl sm:hidden">
      <Link
        to="/donate"
        className="flex items-center justify-center gap-2 bg-accent px-5 py-3.5 text-[0.72rem] font-bold tracking-[0.16em] text-accent-foreground"
      >
        DONATE NOW
      </Link>
    </div>
